...
NB_ITEM_MAX = 18
NB_ITEM_LIGNE = 6
IMAGE_TAILLE_GENERATEUR = 128
TAILLE_CADRE = 163
X_INITIAL = 96
Y_INITIAL = 150
X_INITIAL_CADRE = X_INITIAL - ((TAILLE_CADRE - IMAGE_TAILLE_GENERATEUR)/2)
Y_INITIAL_CADRE = Y_INITIAL - ((TAILLE_CADRE - IMAGE_TAILLE_GENERATEUR)/2)
